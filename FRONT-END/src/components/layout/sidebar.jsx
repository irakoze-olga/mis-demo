...
import { Home, Users, Folder, BarChart2, Settings as SettingsIcon, LogOut, Bell, User } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/notifications', icon: Bell, label: 'Notifications', isNotificationBadge: true },
  ...
  return (
    ...
    <aside className="sidebar" aria-label="Main navigation">
                ...
                >
                  ...
                  {item.badge && (
                    ...
                    <span className="nav-badge">
                      ...
                      {item.isNotificationBadge ? unreadCount : item.badge}
      ...
      <style>{`
        ...
        .nav-link[href="/dashboard"] .nav-icon { color: #6366f1; }

        .nav-link[href="/users"] .nav-icon { color: #10b981; }

        .nav-link[href="/projects"] .nav-icon { color: #f59e0b; }

        .nav-link[href="/reports"] .nav-icon { color: #ef4444; }

        .nav-link[href="/notifications"] .nav-icon { color: #8b5cf6; }

        .nav-link[href="/profile"] .nav-icon { color: #a855f7; }

        .nav-link[href="/settings"] .nav-icon { color: #64748b; }
